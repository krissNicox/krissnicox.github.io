  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=beranda" class="logo"><span style="font-size:20px">Wolftec
</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="http://obedalvarado.pw/" target="_blank">krissnicox</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
